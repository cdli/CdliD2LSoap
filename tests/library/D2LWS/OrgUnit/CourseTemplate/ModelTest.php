...
/**
 * PHPUnit test for D2LWS_OrgUnit_CourseTemplate_Model
 * @author Adam Lundrigan <adamlundrigan@cdli.ca>
 * 
 * @group D2LWS
 * @group D2LWS_Model
 ...
 */
class D2LWS_OrgUnit_CourseTemplate_ModelTest extends GenericTestCase
{
    ...
    public function testCreateNewInstanceWithValidConstructorArgument()
    {
        ...
        $oRole = new D2LWS_OrgUnit_CourseTemplate_Model($mock);
    ...
    {
        $oRole = new D2LWS_OrgUnit_CourseTemplate_Model('shouldNotAcceptString');
    }
    ...
    public function testModelReturnsCorrectTypeInformation()
    {
        ...
        $this->assertEquals('CourseTemplate', $oModel->getOrgUnitTypeID());
