...
/**
 * PHPUnit test for D2LWS_OrgUnit_Organization_Model
 * @author Adam Lundrigan <adamlundrigan@cdli.ca>
 * 
 * @group D2LWS
 * @group D2LWS_Model
 ...
 */
class D2LWS_OrgUnit_Organization_ModelTest extends GenericTestCase
{
    ...
    public function testCreateNewInstanceWithValidConstructorArgument()
    {
        ...
        $oRole = new D2LWS_OrgUnit_Organization_Model($mock);
    ...
    {
        $oRole = new D2LWS_OrgUnit_Organization_Model();
    ...
    {
        $oRole = new D2LWS_OrgUnit_Organization_Model(NULL);
        $this->assertNull($oRole->getRawData());
    }
    ...
    {
        $oRole = new D2LWS_OrgUnit_Organization_Model('shouldNotAcceptString');
    }
    ...
    public function testModelReturnsCorrectTypeInformation()
    {
        ...
        $this->assertEquals('Organization', $oModel->getOrgUnitTypeID());
        $this->assertEquals('Organization', $oModel->getOrgUnitTypeDesc());
    }
